...
public static <T extends Animals> void die(T tamagotchi) {
	 ...
	 */
	public static <T extends Animals>void haveSex(T t) {
		t.setHumor(2);
		t.setCleanliness(false);
		t.doAction(-1, -1, 1);
		...
		else if (t instanceof Phoenix) {
			Phoenix baby = new Phoenix();
			makeBaby(baby);
			baby.setLifeTime(15);
			t.baby = baby;

		} else if (t instanceof Licorne) {
	 ...
	 */
	public static <Generic extends Animals> void makeBaby(Generic baby) {
		System.out.println("Nommer votre bébé");
		Scanner sc = new Scanner(System.in);
		String nameBaby = sc.next();
		baby.setName(nameBaby);
		baby.setColor(baby.getColor());
		baby.setHairColor(baby.getHairColor());
		baby.setHeight(baby.getHeight());

		
		baby.autoGenerated = true;
		System.out.println("\n Voila votre bébé :");
